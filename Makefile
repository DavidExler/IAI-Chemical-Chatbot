...
#ALL_DIRS=webserver keycloak vector-db monitoring elasticsearch langfuse models backend frontend
ALL_DIRS=webserver keycloak monitoring models vector-db langfuse backend frontend
