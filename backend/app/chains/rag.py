...
from app.prompts.rag import get_biological_prompt, get_chemical_prompt, get_prompt
...
class RAGChain(Chain):
    ...
    def description(self) -> str:
        return "RAG (Retrieval-Augmented Generation) model with document retrieval."
    ...
    def get_chain(self) -> Runnable:
        LOGGER.info(f"Creating RAG chain for model: {self.model_id}")
